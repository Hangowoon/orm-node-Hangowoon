...
module.exports = passport =>{
    ...
    // passport.use('new LocalStrategy('로그인화면의 아이디/암호 UI요소의 네임값설정','로그인처리함수정의'));
    passport.use(new LocalStrategy(
        {
            ...
            try{
                ...
                const admin = await db.AdminMember.findOne({where:{admin_id:adminId}});
                ...
                if(admin){
                    ...
                    if(result){
                        ...
                        //관리자 암호가 일치하지 않은 경우
                        //done(null,사용자세션데이터없으면 false, 추가업션데이터);
