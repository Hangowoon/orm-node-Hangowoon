...
-http://locaalhost;3000/articles/create
-요청유형: GET
-응답결과: 신규 게시글 등록 휍페이지
*/
...
-요청URL : http://locaalhost;3000/articles/create
-요청유형: post
...
-요청 URL: http://locaalhost;3000/articles/modify/1
-요청유형: GET
...
/*
-기능 : 게시글 수정페이지에서 사용자가 수정한 게시글 수정정보 처리 요청과 응답 처리 라우팅메소드
-요청URL : http://locaalhost;3000/articles/modify/1
-요청유형: POST
-응답결과: 게시글 목록 휍페이지
*/
...
-http://locaalhost;3000/articles/delete
-요청유형: GET
-응답결과: 게시글 목록 휍페이지
*/
