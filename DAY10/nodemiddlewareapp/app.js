...
//MVC에서 사용하는 viewEngine기술고 ejs를 사용한다고 설정한다.
app.set('view engine', 'ejs');


//app.use()는 미들웨어로 사용자들이 매번 어떠한 요청과 응답을 해오더라고 
//매번 요청이 발생할때마다 실행되는 어플리케이션 미들웨어 함수 기능정의
//하기 모든 app.use()메소드들은 특정 사용자들의 요청과 응답이 발생할때마다 실행되는 기능 
app.use(logger('dev'));
...
// error handler
// MVC 패턴 노드백엔드 환경에서의 서버에러 발생시 처리해주는 전역예외처리기 기능제공
