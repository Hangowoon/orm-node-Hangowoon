...
router.get('/detail',async(req,res)=>{
    ...
    //URLdp QueryString방식으로 파라메터가 전달되면 req.query.키명으로 키의 값을 추출할 수 있다.
...
//호출주소 : http://localhost:3000/product/detail/sandall
router.get('/detail/sendall',async(req,res)=>{
    ...
    //json데이터를 전송해보자
    //res.send({uid:"gowoon",username:"한고운"});
    ...
    //서버에 저장된 파일을 다우로드 해보자
    //console.log("__dirname물리적 경로 확인하기:",__dirname+"maple.jpg");
